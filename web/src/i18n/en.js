const EN_TEXT = {
    ...
    example_from_document: "Please find document for example and details.",
    msp_id: "MSP ID",
    ...
    arguments_input: "Input arguments one by one",
    version: "Version",
    identity: "Identity", 
    ...
    chaincode_constructor_remark: "Strings arguments, one argument per row.",
